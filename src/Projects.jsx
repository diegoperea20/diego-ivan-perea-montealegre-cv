...
function Projects() {
  return (
    <div className='my-projects'>
        ...
        <CardProject url="https://base64-converterd.vercel.app/" title="Base64 Converter" text="This is a web application that allows you to encode and decode Base64 images,audio, text, videos, and other files. 2026 "/>   
        <CardProject url="https://finanzappd.vercel.app/" title="FinanzApp" text="Monthly Financial Management: Track your income, expenses, savings, and investments each month. 2026 "/>      
        ...
        <CardProject url="https://github.com/diegoperea20/appointment-booking-system-pro" title="Appointment Booking System" text="Appointment booking application with Google Calendar integration. Allows users to: Enter their first and last name .Select a date on the calendar .Choose an available time .Book the appointment which automatically syncs with Google Calendar. 2026 "/> 
        <CardProject url="https://github.com/diegoperea20/Restaurant-Recommender-ML" title="Restaurant Recommender ML" text="A comprehensive Machine Learning project that combines two practical applications: a product recommendation system and an intelligent restaurant menu analysis using advanced ML techniques. 2026 "/> 
        <CardProject url="https://video-transcription-pro-d.streamlit.app/" title="Video Transcription Pro" text="Modern web application for transcribing MP4 videos to text using Whisper made with streamlit python. 2026 "/>              
        ...
        <CardProject url="https://animerank-diego.vercel.app/" title="AnimeRank" text="AnimeRank is a web application that allows you to create personalized anime rankings through direct comparisons between them. 2025 "/>
        ...
        <CardProject url="https://tiff-viewer-pro.vercel.app/" title="TIFF Viewer Pro" text="A professional, high-performance TIFF image viewer built with cutting-edge web technologies. Designed specifically for medical imaging, scientific analysis, satellite images , space images and professional visualization with advanced support for multiple TIFF formats and bit depths. 2025 "/>
        <CardProject url="https://github.com/diegoperea20/video-meet-rooms" title="Open Video Meet" text="Open Video Meet is a modern web videoconferencing application built with Next.js and Socket It allows users to create meeting rooms, join them, and enjoy high-quality video calls with advanced features like screen sharing and real-time chat. 2025"/>
