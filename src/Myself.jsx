...
function Myself() {
    ...
    <div className="my-self">
        <div className='container-three-div'>
          ...
          <div class="right-div">
            ...
            artificial intelligence who loves to learn, adapts and
            ...
            Innovative thinking. Able to work in a team and self-manage.
             </p>
            </div>
  ...
  <div class="language-container">
    ...
    <div class="language-item">
      <h4>English</h4>
      <p>Advanced Level <a href="https://www.efset.org/cert/FpmPXy">B2</a></p>
    </div>
    <div class="language-item">
      <h4>Korean </h4>
      <p>Very Basic Level</p>
          ...
          <div className="my-links">
            <a className="my-link" href="https://www.linkedin.com/in/diego-perea-montealegre">
              <p>
                <FaLinkedin />
                Linkedin
              </p>
