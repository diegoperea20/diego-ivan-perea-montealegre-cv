...
import photo_tensorflow from "/src/assets/tensorflow.png";
import photo_pytorch from "/src/assets/pytorch.png";
import photo_vscode from "/src/assets/vscode.png";
  ...
  return (
    <div className='my-skills'>
      ...
      <div className='my-skills-set'>
        ...
        <div className='my-skill-image' > <img src={photo_pytorch}
        alt="PyTorch"/> <p >PyTorch</p></div>
        <div className='my-skill-image' > <img src={photo_vscode}
        alt="Vscode"/> <p >Vscode</p></div>
         <div className='my-skill-image' > <img src={photo_ubuntu}
        alt="Ubuntu"/> <p >Ubuntu</p></div>
        <div className='my-skill-image' > <img src={photo_cpp}
        alt="C++"/> <p >C++</p></div>
        <div className='my-skill-image' > <img src={photo_github}
        alt="Github"/> <p >GitHub</p></div>
        <div className='my-skill-image' > <img src={photo_flask}
        alt="Flask"/> <p >Flask</p></div>
        <div className='my-skill-image' > <img src={photo_powerbi}
        alt="PowerBi"/> <p >PowerBi</p> </div>
        <div className='my-skill-image' > <img src={photo_arduino}
        alt="Arduino"/> <p >Arduino</p> </div>
