    ...
    <div className='my-skills'>
      ...
      <div className='my-skills-set'>
        <div className='my-skill-row'>
          <div className='my-skill-image' > <img src="/src/assets/python.png"
        ...
        alt="Vscode"/> <p >Vscode</p></div>
         <div className='my-skill-image' > <img src="/src/assets/ubuntu.png"
        alt="Ubuntu"/> <p >Ubuntu</p></div>
        <div className='my-skill-image' > <img src="/src/assets/c++.png"
        alt="C++"/> <p >C++</p></div>
        <div className='my-skill-image' > <img src="/src/assets/github.png"
        alt="Github"/> <p >GitHub</p></div>
        <div className='my-skill-image' > <img src="/src/assets/Flask.png"
        alt="Flask"/> <p >Flask</p></div>
        <div className='my-skill-image' > <img src="/src/assets/powerbi.png"
        alt="PowerBi"/> <p >PowerBi</p> </div>
        <div className='my-skill-image' > <img src="/src/assets/arduino.png"
